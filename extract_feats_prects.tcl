...
##READ NETLIST
#read_verilog ${run_dir}/prects/netlist/netlist.v
#link_design $design

##READ DEF
read_def ${run_dir}/prects/def/def.def

##READ SDC
read_sdc ${run_dir}/prects/sdc/sdc.sdc
...
start_stage "actual_delay_prects"
exec mkdir -p $folder_name/actual_delay
set new_file [open $folder_name/actual_delay/actual_delay_prects.csv w+]
source ./report_delay.tcl
close $new_file
end_stage "actual_delay_prects.csv"
