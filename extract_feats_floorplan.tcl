...
##READ NETLIST
read_verilog ${run_dir}/floorplan/netlist/netlist.v
link_design $design

##READ SDC
read_sdc ${run_dir}/floorplan/sdc/sdc.sdc
...
start_stage "actual_delay_floorplan"
exec mkdir -p $folder_name/actual_delay
set new_file [open $folder_name/actual_delay/actual_delay_floorplan.csv w+]
source ./report_delay.tcl
close $new_file
end_stage "actual_delay_floorplan".csv"
